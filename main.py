...
tf.app.flags.DEFINE_string("train_dir", "./train2VAE9", "train_dir")
tf.app.flags.DEFINE_string("log_dir", "./log2VAE9", "log_dir")
...
tf.app.flags.DEFINE_string("infer_path_resp", "./test.inferVAE8", "path of the resp file to be infer")
...
tf.app.flags.DEFINE_integer("full_kl_step", 40000, "kl_weight increase from 0 to 1 linearly in full_kl_step")
