...
tf.app.flags.DEFINE_string("train_dir", "./trainVAEMom2", "train_dir")
tf.app.flags.DEFINE_string("log_dir", "./logVAEMom2", "log_dir")
...
tf.app.flags.DEFINE_integer("full_kl_step", 10000, "kl_weight increase from 0 to 1 linearly in full_kl_step")
